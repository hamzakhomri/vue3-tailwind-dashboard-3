          ...
          <div class="flex">
              <div class="flex-auto w-[60%] ">
                        ...
                        <template v-else-if="current === 'Categories'">
                          ...
                          <select id="countries" v-model="CategoryToUpdate" :class="['border-2','appearance-none','block','w-full','bg-white','dark:bg-gray-900','text-gray-800','dark:text-gray-100','rounded-lg','py-3','px-4',{'border-red-500': idProductCategory.length <= 0 },{ 'border-green-500': idProductCategory.length >= 1 }]">
        ...
        <div v-if="DialogueUpdate" class=" modal text-gray-500 p-2 border-2 border-solid border-red-300 rounded bg-red-400">
          ...
          <div class="flex justify-center space-x-3 mb-3 mr-2">
              ...
              <div class="relative w-full flex space-x-2">
                  ...
                  <select id="countries" v-model="CategoryToUpdate" :class="['border-2','appearance-none','block','w-full','bg-gray-50','dark:bg-gray-700','text-gray-800','dark:text-gray-100','rounded-lg','py-3','px-4',{'border-red-500': idProductCategory.length <= 0 },{ 'border-green-500': idProductCategory.length >= 1 }]">
...
setup() {
  ...
  // ============= UPDATE==============================================
confirmUpdate(idProducts, Productname, productCategory, priceProducts, qteProducts) {
  ...
  this.CategoryToUpdate = productCategory;
  ...
  console.log("To Update: " + this.CategoryToUpdate);
  console.log("ProductnameToUpdate: " + this.ProductnameToUpdate);
},
...
// ============= DELETE ==============================================
  ...
  // ============= REQUETE ==============================================
        ...
        updateProduct(idProducts, ProductnameToUpdate, CategoryToUpdate, ProductPricetToUpdate, ProductQteToUpdate, idProductCategory) {
