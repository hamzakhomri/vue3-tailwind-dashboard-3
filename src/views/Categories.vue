          ...
          <tbody>
            ...
            class="relative font-bold bg-gray-100 hover:bg-blue-100 border border-indigo-600 dark:bg-gray-800 dark:hover:bg-gray-600   dark:border-gray-700 w-96">
              ...
              <td class="py-4 px-6 text-right">
                <button @click="confirmDelete(category.idProductCategory)" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md">
              ...
              <td class="py-4 px-6 text-right">
                <button @click="confirmUpdate(category.idProductCategory,category.nameProductCategory)" class="inline-flex items-center px-4 py-2 bg-green-400 hover:bg-green-500 text-gray-800 text-sm font-medium rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <transition name="slide">
            <div v-if="DialogueDelete && categoryIdToDelete===category.idProductCategory" class="flex items-center justify-center absolute top-0 left-0 w-full h-full  bg-red-200 modal text-gray-500 py-4">
              <div class="flex justify-center space-x-3">
                <!-- <h3 class="text-red-500">Vous voulez vraiment Supprimer se categories {{ categoryIdToDelete }} :</h3> -->
                <div class="modal-buttons space-x-3">
                
                  <button @click="deleteProductCategory(categoryIdToDelete)" class="inline-flex items-center justify-center w-40 h-8 mr-2 text-pink-100 transition-colors duration-150 bg-red-700 rounded-lg focus:shadow-outline hover:bg-red-800">
